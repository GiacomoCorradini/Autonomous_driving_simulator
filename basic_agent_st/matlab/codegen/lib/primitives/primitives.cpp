             ...
             double T)
{
  ...
  b_out1_tmp = T * vf;
  return ((a0 -
           1.0 / rt_powd_snf(T, 5.0) * rt_powd_snf(t, 3.0) *
...
// Return Type  : void
//
void pass_primitive(double a0, double v0, double sf, double v_min, double v_max,
                    double t_min, double t_max, double m1[6], double m2[6],
                    double *t1, double *t2)
{
  double tv_min_tmp;
  double v_bar;
  ...
  if (a0 >= 0.0) {
    ...
    *t2 = -(3.872983346207417 * std::sqrt(-a0 * sf)) / a0;
    ...
    if ((v_bar < v_min) && (v_min < v_max)) {
      ...
      //     version 9.1. 29-Nov-2022 16:34:33
      *t2 =
          sf * 30.0 /
          ((v0 * 7.0 + v_min * 8.0) +
  ...
  if ((*t1 > 0.0) && (*t1 <= *t2)) {
    ...
    //     29-Nov-2022 16:34:10
    t3 = 0.0 * tv_min_tmp;
    t4_tmp_tmp = a0 * tv_min_tmp;
    t4 = t4_tmp_tmp * 3.0;
    m1[0] = 0.0;
    m1[1] = v0;
    m1[2] = a0;
    v_bar = *t1 * (((sf * -15.0 + vf_tmp * 7.0) + t4_tmp_tmp) * -0.125 / *t1);
    m1[3] = 1.0 / rt_powd_snf(*t1, 3.0) *
            ((((sf * -20.0 + t4) + -t3) + vf_tmp * 12.0) + v_bar * 8.0) * -3.0;
    m1[4] = 1.0 / (tv_min_tmp * tv_min_tmp) *
            ((((sf * -30.0 - t3 * 2.0) + t4) + vf_tmp * 16.0) + v_bar * 14.0) *
            12.0;
    m1[5] = 1.0 / rt_powd_snf(*t1, 5.0) *
            ((((sf * -12.0 + -t3) + vf_tmp * 6.0) + v_bar * 6.0) + t4_tmp_tmp) *
            -60.0;
    tv_min_tmp = *t2 * *t2;
    vf_tmp = *t2 * v0;
    // evalPrimitiveCoeffs
    ...
    m2[1] = v0;
    m2[2] = a0;
    v_bar = *t2 * (((sf * -15.0 + vf_tmp * 7.0) + t4_tmp_tmp) * -0.125 / *t2);
    m2[3] = 1.0 / rt_powd_snf(*t2, 3.0) *
            ((((sf * -20.0 + t4) + -t3) + vf_tmp * 12.0) + v_bar * 8.0) * -3.0;
    m2[4] = 1.0 / (tv_min_tmp * tv_min_tmp) *
            ((((sf * -30.0 - t3 * 2.0) + t4) + vf_tmp * 16.0) + v_bar * 14.0) *
            12.0;
  ...
  if ((v_min < *vfj0) && (*vfj0 < v_max)) {
    ...
    *vfj0 = ((sf * -20.0 + vfj0_tmp) + b_vfj0_tmp) * -0.125 / *tfj0;
    if ((v_min < *vfj0) && (*vfj0 < v_max)) {
      ...
      //     M = evalPrimitiveCoeffs(V0,A0,SF,VF,AF,T)
      //     This function was generated by the Symbolic Math Toolbox
      //     version 9.1. 29-Nov-2022 16:34:10
      t3 = 0.0 * t2;
      m[0] = 0.0;
      m[1] = v0;
      m[2] = a0;
